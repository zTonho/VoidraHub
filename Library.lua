...
local BaseURL = "https://raw.githubusercontent.com/zTonho/VoidraHub/refs/heads/main/"
local CustomImageManager = {}
local CustomImageManagerAssets = {
    TransparencyTexture = {
        RobloxId = 139785960036434,
        Path = "VoidraHub/assets/TransparencyTexture.png",
    ...
    SaturationMap = {
        RobloxId = 4155801252,
        Path = "VoidraHub/assets/SaturationMap.png",
    ...
    LoadingIcon = {
        ...
        Path = "VoidraHub/assets/LoadingIcon.png",
    ...
    CheckIcon = {
        ...
        Path = "VoidraHub/assets/CheckIcon.png",
...
do
    ...
    function CustomImageManager.AddAsset(
        ...
        CustomImageManagerAssets[AssetName] = {
            ...
            Path = string.format("VoidraHub/custom_assets/%s", AssetName),
            URL = URL,
